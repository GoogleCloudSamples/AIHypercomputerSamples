# Serve Llama 4 Scout A4 on a GKE cluster

This sample provides a set of scripts to serve the Llama 4 Scout A4 model on Google Kubernetes Engine (GKE) for inference. It is intended for machine learning engineers and developers looking to deploy large language models on Google Cloud.
