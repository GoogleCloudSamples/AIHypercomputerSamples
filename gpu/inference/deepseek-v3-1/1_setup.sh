...
# [START hypercomputer_gpu_infer_deepseek31_cluster_create_auto]
...
# [START hypercomputer_gpu_infer_deepseek31_cluster_get_creds]
gcloud container clusters get-credentials $CLUSTER_NAME \
    --location=$REGION
# [END hypercomputer_gpu_infer_deepseek31_cluster_get_creds]

echo "[$(date)] ==================== Creating hf-secret secret... ===================="
# [START hypercomputer_gpu_infer_deepseek31_secret_create]
kubectl create secret generic hf-secret \
    --from-literal=hf_token=${HUGGING_FACE_TOKEN} \
    --dry-run=client -o yaml | kubectl apply -f -
# [END hypercomputer_gpu_infer_deepseek31_secret_create]