# Serve Qwen 3 (235B) on a GKE cluster

This sample provides a set of scripts to serve the Qwen 3 (235B) model on Google Kubernetes Engine (GKE) for inference. It is intended for machine learning engineers and developers looking to deploy large language models on Google Cloud.
...
* `3_interact_with_model.sh`: Interacts with the deployed model.
...
* [Use vLLM on GKE to run inference with Qwen3](https://docs.cloud.google.com/ai-hypercomputer/docs/tutorials/gpu/qwen3-vllm-inference)
