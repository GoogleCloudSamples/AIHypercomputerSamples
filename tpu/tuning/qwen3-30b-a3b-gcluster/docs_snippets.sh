...
# [START hypercomputer_tpu_tune_qwen3_30b_rl_cb_env]
...
# [END hypercomputer_tpu_tune_qwen3_30b_rl_cb_env]

# [START hypercomputer_tpu_tune_qwen3_30b_rl_cb_kubectl_install]
gcloud components install kubectl gke-gcloud-auth-plugin --quiet
# [END hypercomputer_tpu_tune_qwen3_30b_rl_cb_kubectl_install]

# [START hypercomputer_tpu_tune_qwen3_30b_rl_create_role]
...
# [START hypercomputer_tpu_tune_qwen3_30b_rl_train_logs]
# Use the list command to check status
./gcluster job list \
    --cluster ${CLUSTER_NAME} \
    --project ${PROJECT} \
...
./gcluster job logs qwen-training --main-only -f \
    ...
    --project ${PROJECT} \
    --location ${REGION}
# [END hypercomputer_tpu_tune_qwen3_30b_rl_train_logs]
...
# [END hypercomputer_tpu_tune_qwen3_30b_rl_cleanup_storage]
...
# [END hypercomputer_tpu_tune_qwen3_30b_rl_yaml_gke_cluster]