# _TUTORIAL_TITLE_
# Example: Fine-tune Qwen3 on a TPU GKE Cluster

This code sample is intended for AI/ML engineers and demonstrates how to fine-tune the Qwen3 model on a TPU GKE cluster on Google Cloud.
