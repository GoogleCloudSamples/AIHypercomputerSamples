...
# [START hypercomputer_tpu_tune_gemma4_e4b_rl_env]
...
export MODEL_NAME="gemma4-e4b"
export HF_TOKEN="YOUR_HF_TOKEN"
# [END hypercomputer_tpu_tune_gemma4_e4b_rl_env]

echo "[$(date)] ==================== Installing Prerequisites ===================="
# [START hypercomputer_tpu_tune_gemma4_e4b_rl_install_terraform]
...
# [END hypercomputer_tpu_tune_gemma4_e4b_rl_install_terraform]
